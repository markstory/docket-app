...
enum Menu { archive, edit, addSection, viewCompleted }
  ...
  Widget build(BuildContext context) {
    ...
    void handleEdit() {
      Navigator.pushNamed(
        context,
        Routes.projectEdit,
        arguments: ProjectDetailsArguments(viewmodel.project),
      );
    }
    ...
    void handleAddSection() async {
      try {
        ...
        messenger.showSnackBar(
          successSnackBar(context: context, text: 'Could not create section'),
        );
      }
    }
