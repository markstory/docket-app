...
class CalendarProviderListScreen extends StatefulWidget {
  ...
  @override
  State<CalendarProviderListScreen> createState() =>
      _CalendarProviderListScreenState();
}

class _CalendarProviderListScreenState
    extends State<CalendarProviderListScreen> {
  ...
  void initState() {
    ...
    viewmodel = Provider.of<CalendarProviderListViewModel>(
      context,
      listen: false,
    );
    viewmodel.loadData();
  ...
  Widget build(BuildContext context) {
    return Consumer<CalendarProviderListViewModel>(
      builder: (context, viewmodel, child) {
        ...
        if (viewmodel.loading) {
          ...
          children.addAll(
            viewmodel.providers
                .map((provider) => CalendarProviderItem(provider: provider))
                .toList(),
          );
