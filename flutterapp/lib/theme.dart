...
final lightTheme = ThemeData(
  ...
  colorScheme: const ColorScheme(
    ...
    secondaryContainer: DocketColors.gray100,
    ...
    surface: DocketColors.gray000,
    onSurface: DocketColors.black,
    // Used for high contrast backgrounds
    surfaceContainerHighest: DocketColors.white,
...
final darkTheme = ThemeData(
  ...
  colorScheme: const ColorScheme(
    ...
    surface: DocketColors.gray900,
    onSurface: DocketColors.white,
    // Used for high contrast backgrounds
    surfaceContainerHighest: DocketColors.gray900,
    surfaceTint: DocketColors.purple900,
  ),
  dialogTheme: const DialogThemeData(backgroundColor: DocketColors.gray900),
