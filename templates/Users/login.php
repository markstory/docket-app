...
<?= $this->Form->create(null, ['class' => 'form-narrow', 'url' => ['controller' => 'Users', 'action' =>'login']]) ?>
...
<div class="button-bar">
    ...
    <?= $this->Html->link('Forgot Password?', ['_path' => 'Users::resetPassword'], ['class' => 'button button-muted']) ?>
</div>
<div class="button-bar">
