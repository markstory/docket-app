 ...
 * @property \Tasks\Model\Table\SubtasksTable&\Cake\ORM\Association\HasMany $Subtasks
 * @property \Tasks\Model\Table\LabelsTable&\Cake\ORM\Association\BelongsToMany $Labels
 * @property \Tasks\Model\Table\ProjectSectionsTable&\Cake\ORM\Association\BelongsTo $ProjectSections
 ...
 * @method \Tasks\Model\Entity\Task get($primaryKey, $options = [])
 * @method \Tasks\Model\Entity\Task findOrCreate($search, ?callable $callback = null, $options = [])
 ...
 * @method iterable<mixed, \Tasks\Model\Entity\Task>|false saveMany(iterable $entities, $options = [])
 * @method iterable<mixed, \Tasks\Model\Entity\Task> saveManyOrFail(iterable $entities, $options = [])
 * @method iterable<mixed, \Tasks\Model\Entity\Task>|false deleteMany(iterable $entities, $options = [])
 * @method iterable<mixed, \Tasks\Model\Entity\Task> deleteManyOrFail(iterable $entities, $options = [])
...
class TasksTable extends Table
{
    ...
    public function move(Task $item, array $operation): void
    {
        ...
        foreach ($updateFields as $key => $value) {
            ...
            if ($fieldValue instanceof Date && is_string($value)) {
        ...
        $difference = (int)$current - (int)$targetOffset;
