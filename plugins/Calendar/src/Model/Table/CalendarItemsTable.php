 ...
 * @method \Calendar\Model\Entity\CalendarItem newEmptyEntity()
 * @method \Calendar\Model\Entity\CalendarItem newEntity(array $data, array $options = [])
 * @method \Calendar\Model\Entity\CalendarItem[] newEntities(array $data, array $options = [])
 * @method \Calendar\Model\Entity\CalendarItem get($primaryKey, $options = [])
 * @method \Calendar\Model\Entity\CalendarItem findOrCreate($search, ?callable $callback = null, $options = [])
 * @method \Calendar\Model\Entity\CalendarItem patchEntity(\Cake\Datasource\EntityInterface $entity, array $data, array $options = [])
 * @method \Calendar\Model\Entity\CalendarItem[] patchEntities(iterable $entities, array $data, array $options = [])
 * @method \Calendar\Model\Entity\CalendarItem|false save(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method \Calendar\Model\Entity\CalendarItem saveOrFail(\Cake\Datasource\EntityInterface $entity, $options = [])
 * @method iterable<mixed, \Calendar\Model\Entity\CalendarItem>|false saveMany(iterable $entities, $options = [])
 * @method iterable<mixed, \Calendar\Model\Entity\CalendarItem> saveManyOrFail(iterable $entities, $options = [])
 * @method iterable<mixed, \Calendar\Model\Entity\CalendarItem>|false deleteMany(iterable $entities, $options = [])
 * @method iterable<mixed, \Calendar\Model\Entity\CalendarItem> deleteManyOrFail(iterable $entities, $options = [])
